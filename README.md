# Hi there, I'm Hitarth Patel 👋

I am a second-year B.Tech Information and Communication Technology (ICT) student. I specialize in bridging the gap between machine learning algorithms and functional web interfaces. I enjoy building full-stack applications, predicting Formula 1 outcomes, and exploring deep learning architectures.
...
*   **Tech Stack:** Python, Machine Learning, HTML, Render

### [Smart Building Energy Load Estimator](https://github.com/hitarthpatel2404/SmartLoad-AI-Powered-Building-Energy-Estimator)
An AI-powered tool designed to estimate energy loads for smart buildings, featuring a custom machine learning model integrated with a robust backend.
*   **Tech Stack:** Flask, Machine Learning, HTML

### [HackTeamMatcher](https://github.com/hitarthpatel2404/HackTeamMatcher)
A web platform designed to help developers easily find teammates and form cross-functional groups for hackathons.
*   **Tech Stack:** Python
